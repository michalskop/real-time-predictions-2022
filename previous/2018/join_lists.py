...
pss.merge(pss0, on="id", how="left", suffixes=("", "_0")).to_csv(localpath + "polling_stations_2017_2018.csv", index=False)
...
pssgv.to_csv(localpath + "polling_stations_2017_2018_groups.csv", index=False)
